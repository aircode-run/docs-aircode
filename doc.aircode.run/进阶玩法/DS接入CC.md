---
title: "DS接入CC"
source: "https://docs.aircode.run/docs/advanced/DeepSeekClaudeCode.html#%E9%AA%8C%E8%AF%81%E9%85%8D%E7%BD%AE"
author:
  - "[[Packy Team]]"
published: 2026-05-22
created: 2026-05-31
description: "前置准备 本教程用于将 DeepSeek 分组接入 Claude Code 使用。开始前请先确认本地已经完成 Claude Code 安装；如果还没有安装，可以先参考 中的安装与基础配置步骤。 创建 DeepSeek 令牌 回顾 ，在 aircode 中创建新的 API 令牌。 名称可以填写 deepseek-officially，令牌分组请选择 d..."
tags:
  - "clippings"
---
## 前置准备

本教程用于将 **DeepSeek** 分组接入 **Claude Code** 使用。开始前请先确认本地已经完成 Claude Code 安装；如果还没有安装，可以先参考 [Claude Code配置](../CLI配置教程/Claude Code配置.md) 中的安装与基础配置步骤。

## 创建 DeepSeek 令牌

1. 回顾 [创建 API 令牌](../快速开始/创建 API 令牌.md) ，在 aircode 中创建新的 API 令牌。
2. 名称可以填写 `deepseek-officially` ，令牌分组请选择 `official` 。创建完成后，复制生成的 API Key，后续配置会用到。
...
![](assets/Pasted%20image%2020260531210743.png)
...
![](assets/Pasted%20image%2020260531210817.png)
