---
title: "Codex相关问题"
source: "https://docs.aircode.run/docs/faq/Codex.html"
author:
  - "[[Packy Team]]"
published: 2026-05-22
created: 2026-05-31
description: "一点点技巧，如何更高效地使用Codex 很多人可能会在使用过一段时间Codex后认为模型不如以前好用，也就是出现所谓的“降智”现象 而就目前我的使用体验来看，Codex中提供的模型经过很多次升级，其实都没有出现“降智”，关键是在于你如何合理地去使用模型 任务划分： 任何时候，都不要去提交一个非常笼统的任务，例如 请帮我写一个管理系统后台 等，这样使用必..."
tags:
  - "clippings"
---
### 一点点技巧，如何更高效地使用Codex
...
intl.cpl
```
![](assets/Pasted%20image%2020260531212728.png)
2. 点击上侧选项卡“管理”，再点击红色箭头所示的“更改系统区域设置”按钮
![](assets/Pasted%20image%2020260531212739.png)

3. 勾选红色箭头所指选项，点击确定。然后在刚才的窗口也点击确定，之后重启一下你的电脑再使用codex，即可避免乱码
![](assets/Pasted%20image%2020260531212746.png)



### Codex如何配置全局提示词

1. 请你查看 [Codex CLI 配置](../CLI配置教程/Codex配置.md) 中的前两步
...
```
3. 运行Codex，进行尝试
![](assets/Pasted%20image%2020260531213023.png)
...
2. 查看 [Codex在CLI中的配置](../CLI配置教程/Codex配置.md) 一章
