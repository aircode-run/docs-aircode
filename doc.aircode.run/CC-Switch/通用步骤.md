---
title: "通用步骤"
source: "https://docs.aircode.run/docs/ccswitch/1-common.html"
author:
  - "[[Packy Team]]"
published: 2026-05-22
created: 2026-05-31
description: "CC-Switch介绍 Claude Code / Codex / Gemini CLI 全方位辅助工具 Version Trending Platform Built with Tauri Downloads farion1231%2Fcc-switch | Trendshift | 下载地址 从供应商切换器到 AI CLI 一体化管理平台 统一管理..."
tags:
  - "clippings"
---
### CC-Switch介绍
...
![](https://docs.aircode.run/assets/image/CC-Switch/001.webp)

3. 安装后运行CC-Switch主程序，界面如下。
![](https://docs.aircode.run/assets/image/CC-Switch/002.webp)
