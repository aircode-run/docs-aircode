...
```
![](https://docs.aircode.run/assets/image/Cli/002.webp)
...
claude
```
![](https://docs.aircode.run/assets/image/Cli/003.webp)
...
codex
```
![](https://docs.aircode.run/assets/image/Cli/004.webp)
...
gemini
```
![](https://docs.aircode.run/assets/image/Cli/005.webp)