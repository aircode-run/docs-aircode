---
title: "环境检查(通用步骤)"
source: "https://docs.aircode.run/docs/cli/1-env.html"
author:
  - "[[Packy Team]]"
published: 2026-05-22
created: 2026-05-31
description: "（1）确认Nodejs环境已安装 在windows或MacOS终端输入以下命令 正常情况应该是如下图所示（没有任何内容也没关系），如果提示“命令未找到”，则说明你没有安装Nodejs，你需要按 此教程 来安装运行Claude Code、Codex、Gemini所需的环境 如果你发现自己没有安装Nodejs，并且跟着教程目前已经安装完毕，请你重新执行上述..."
tags:
  - "clippings"
---
### （1）确认Nodejs环境已安装
...
![](assets/Pasted%20image%2020260601172756.png)
...
```
![](assets/Pasted%20image%2020260601172810.png)
...
claude
```
![](assets/Pasted%20image%2020260601172826.png)
...
codex
```
![](assets/Pasted%20image%2020260601172838.png)
...
gemini
```
![](assets/Pasted%20image%2020260601172848.png)
