---
title: "Codex配置"
source: "https://docs.aircode.run/docs/cli/3-codex.html"
author:
  - "[[Packy Team]]"
...
%userprofile%\.codex
```
![](assets/Pasted%20image%2020260601135455.png)
2. 你的目录中可能会存在以下文件，不过我们用到的文件只有三个，需要配置的只有两个
![](assets/Pasted%20image%2020260601135503.png)
...
```
![](assets/Pasted%20image%2020260601135540.png)

回顾 [创建API令牌](../快速开始/创建 API 令牌.md) 这一步教程，我们需要在aircode中创建 令牌，然后点击右侧的复制按钮，将key填入“xxx”部分后保存

![](assets/Pasted%20image%2020260601135605.png)
...
codex
```
![](assets/Pasted%20image%2020260601135551.png)
...
~/.codex
```
![](assets/Pasted%20image%2020260601135632.png)

2. 你的目录中可能会存在以下文件，不过我们用到的文件只有三个，需要配置的只有两个，其它文件可忽略
![](assets/Pasted%20image%2020260601135641.png)
...
```
![](assets/Pasted%20image%2020260601135654.png)

回顾 [创建API令牌](../快速开始/创建 API 令牌.md) 这一步教程，我们需要在aircode中创建 令牌，然后点击右侧的复制按钮，将key填入“xxx”部分后保存

![](assets/Pasted%20image%2020260601135710.png)
...
codex
```
![](assets/Pasted%20image%2020260601135720.png)